...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                'payloads': [
                    ('range', {'default': '0-4', 'encoder': None}, None)
                ]
            },
            [('0',), ('1',), ('2',), ('3',), ('4',)]
        ),
        ...
        (
            {'payloads': [('ipnet', {'default': '192.168.0.1/30', 'encoder': None}, None)]},
            [('192.168.0.1',), ('192.168.0.2',)]
        ),
        (
            {'payloads': [('iprange', {'default': '192.168.0.1-192.168.0.2', 'encoder': None}, None)]},
            [('192.168.0.1',), ('192.168.0.2',)]
        ),
        (
